...
public class CategoryController {
    ...
    @PostMapping("/create")
    public String createProccess(CategoryBindingModel categoryBindingModel) {
    ...
    @PostMapping("/edit/{id}")
    public String editProccess(@PathVariable Integer id, CategoryBindingModel categoryBindingModel){
        if(!this.categoryRepository.exists(id)){
            return "redirect:/admin/categories";
        }
    ...
    public String deleteProccess(@PathVariable Integer id){
        if(!this.categoryRepository.exists(id)){
            return "redirect:/admin/categories/";
        }
